!function (t, e) {
    ...
    var z = C.Utils, o = z.getScrollParents, n = z.getBounds, r = z.getOffsetParent, a = z.extend, l = z.addClass,
        f = z.removeClass, p = z.updateClasses, S = z.defer, W = z.flush, s = z.getScrollBarSize,
        i = z.removeUtilElements, B = function () {
    ...
    var Y = {center: "center", left: "right", right: "left"}, D = {middle: "middle", top: "bottom", bottom: "top"},
        L = {top: 0, left: 0, middle: "50%", center: "50%", bottom: "100%", right: "100%"}, X = function (t, e) {
            ...
            return c(h, e), w(h, [{
                ...
                key: "getTargetBounds", value: function () {
                    ...
                    if ("visible" === this.targetModifier) {
                        ...
                        var t = n(this.target), e = {height: t.height, width: t.width, top: t.top, left: t.left};
                ...
                key: "position", value: function () {
                    ...
                    if (this.enabled) {
                        ...
                        var h = this.cache("target-bounds", function () {
                            ...
                            }), d = h, u = y(H(this.attachment), {width: a, height: f}), p = y(H(o), d),
                            c = y(this.offset, {width: a, height: f}), g = y(this.targetOffset, d);
                        u = v(u, c), p = v(p, g);
                        ...
                        }, A = this.target.ownerDocument, T = A.defaultView, P = void 0;
                ...
                key: "move", value: function (t) {
                    ...
                    if ("undefined" != typeof this.element.parentNode) {
                        ...
                        var v = {}, y = !1;
                        for (var n in h) {
                            var b = h[n], w = this.element.style[n];
                            w !== b && (y = !0, v[n] = b)
                        }
                        y && S(function () {
    ...
    var V = a(U, C), k = function () {
        ...
        }(), z = C.Utils, n = z.getBounds, a = z.extend, p = z.updateClasses, S = z.defer,
    ...
    C.modules.push({
        position: function (t) {
            ...
            }), u = d.height, c = d.width, g = [this.getClass("pinned"), this.getClass("out-of-bounds")];
    ...
    C.modules.push({
        position: function (t) {
            ...
            var u = [], c = [], g = ["left", "top", "right", "bottom"];
